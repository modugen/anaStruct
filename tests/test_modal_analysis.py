...
def test_solve_modal_analysis():
    ...
    # retrieve fist eigenvalues quarters, as error increases for higher eigenvalues
    for i in range(int(n / 4)):
        assert np.isclose(natural_frequencies[i], analytical_natural_frequencies(10, 10, 800, i + 1), rtol=1e-1)
